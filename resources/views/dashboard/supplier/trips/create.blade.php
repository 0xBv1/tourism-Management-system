...
@section('content')
    <form action="{{ route('supplier.trips.store') }}" method="POST" class="page-body" enctype="multipart/form-data">
        @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelector('form').addEventListener('submit', function(e) {
                ...
                console.log('Departure City:', document.getElementById('departure_city').value);
                console.log('Arrival City:', document.getElementById('arrival_city').value);
                console.log('Travel Date:', document.getElementById('travel_date').value);
