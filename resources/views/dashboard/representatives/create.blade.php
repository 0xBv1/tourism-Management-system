...
@section('content')
    <div class="page-body">
        ...
        <x-dashboard.partials.breadcrumb title="Create Representative">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('dashboard.representatives.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('company_license') is-invalid @enderror" 
                                                   id="company_license" name="company_license" value="{{ old('company_license') }}">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="specializations[]" value="group_tours" 
                                                       id="spec_group_tours" {{ in_array('group_tours', old('specializations', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="specializations[]" value="corporate_events" 
                                                       id="spec_corporate" {{ in_array('corporate_events', old('specializations', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="specializations[]" value="business_tours" 
                                                       id="spec_business" {{ in_array('business_tours', old('specializations', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="specializations[]" value="educational_tours" 
                                                       id="spec_educational" {{ in_array('educational_tours', old('specializations', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="specializations[]" value="luxury_tours" 
                                                       id="spec_luxury" {{ in_array('luxury_tours', old('specializations', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="service_areas[]" value="city_center" 
                                                       id="area_city_center" {{ in_array('city_center', old('service_areas', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="service_areas[]" value="historical_district" 
                                                       id="area_historical" {{ in_array('historical_district', old('service_areas', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="service_areas[]" value="business_district" 
                                                       id="area_business" {{ in_array('business_district', old('service_areas', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="service_areas[]" value="airport" 
                                                       id="area_airport" {{ in_array('airport', old('service_areas', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="service_areas[]" value="hotels" 
                                                       id="area_hotels" {{ in_array('hotels', old('service_areas', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="service_areas[]" value="convention_center" 
                                                       id="area_convention" {{ in_array('convention_center', old('service_areas', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="service_areas[]" value="shopping_areas" 
                                                       id="area_shopping" {{ in_array('shopping_areas', old('service_areas', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="service_areas[]" value="entertainment_district" 
                                                       id="area_entertainment" {{ in_array('entertainment_district', old('service_areas', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="certifications[]" value="Business License" 
                                                       id="cert_business" {{ in_array('Business License', old('certifications', [])) ? 'checked' : '' }}>
