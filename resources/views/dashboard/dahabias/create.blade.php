...
@section('content')
    <div class="page-body">
        ...
        <x-dashboard.partials.breadcrumb title="Create Dahabia">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5>Create Dahabia</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('dashboard.dahabias.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('capacity') is-invalid @enderror" 
                                                   id="capacity" name="capacity" value="{{ old('capacity') }}" min="1" placeholder="Number of passengers">
                                            @error('capacity')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('price_per_charter') is-invalid @enderror" 
                                                   id="price_per_charter" name="price_per_charter" value="{{ old('price_per_charter') }}" min="0" placeholder="0.00">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('departure_location') is-invalid @enderror" 
                                                   id="departure_location" name="departure_location" value="{{ old('departure_location') }}" placeholder="Starting point">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('arrival_location') is-invalid @enderror" 
                                                   id="arrival_location" name="arrival_location" value="{{ old('arrival_location') }}" placeholder="Ending point">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('route_description') is-invalid @enderror" 
                                                      id="route_description" name="route_description" rows="3" placeholder="Describe the sailing route">{{ old('route_description') }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('crew_count') is-invalid @enderror" 
                                                   id="crew_count" name="crew_count" value="{{ old('crew_count') }}" min="0" placeholder="Number of crew members">
                                            @error('crew_count')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('duration_nights') is-invalid @enderror" 
                                                   id="duration_nights" name="duration_nights" value="{{ old('duration_nights') }}" min="0" placeholder="Number of nights">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control @error('meal_plan') is-invalid @enderror" 
                                                ...
                                                <option value="full_board" {{ old('meal_plan') == 'full_board' ? 'selected' : '' }}>Full Board</option>
                                                <option value="half_board" {{ old('meal_plan') == 'half_board' ? 'selected' : '' }}>Half Board</option>
                                                <option value="bed_breakfast" {{ old('meal_plan') == 'bed_breakfast' ? 'selected' : '' }}>Bed & Breakfast</option>
                                                <option value="all_inclusive" {{ old('meal_plan') == 'all_inclusive' ? 'selected' : '' }}>All Inclusive</option>
                                            </select>
                                            @error('meal_plan')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('amenities') is-invalid @enderror" 
                                                      id="amenities" name="amenities" rows="2" placeholder="List available amenities (e.g., Air conditioning, WiFi, Minibar)">{{ old('amenities') }}</textarea>
                                            @error('amenities')
                                                @enderror
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save me-1"></i>Create Dahabia
                                        </button>
