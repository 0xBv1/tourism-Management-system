...
@section('content')
    <div class="page-body">
        ...
        <x-dashboard.partials.breadcrumb title="Edit Ticket">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5>Edit Ticket: {{ $ticket->name }}</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('dashboard.tickets.update', $ticket) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('price_per_person') is-invalid @enderror" 
                                                   id="price_per_person" name="price_per_person" value="{{ old('price_per_person', $ticket->price_per_person) }}" min="0" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control @error('currency') is-invalid @enderror" 
                                                ...
                                                <option value="EUR" {{ old('currency', $ticket->currency) == 'EUR' ? 'selected' : '' }}>EUR</option>
                                                <option value="GBP" {{ old('currency', $ticket->currency) == 'GBP' ? 'selected' : '' }}>GBP</option>
                                                <option value="EGP" {{ old('currency', $ticket->currency) == 'EGP' ? 'selected' : '' }}>EGP</option>
                                            </select>
                                            @error('currency')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="0.5" class="form-control @error('duration_hours') is-invalid @enderror" 
                                                   id="duration_hours" name="duration_hours" value="{{ old('duration_hours', $ticket->duration_hours) }}" min="0">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('max_participants') is-invalid @enderror" 
                                                   id="max_participants" name="max_participants" value="{{ old('max_participants', $ticket->max_participants) }}" min="1">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('min_age') is-invalid @enderror" 
                                                   id="min_age" name="min_age" value="{{ old('min_age', $ticket->min_age) }}" min="0" max="18">
                                            @error('min_age')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('max_age') is-invalid @enderror" 
                                                   id="max_age" name="max_age" value="{{ old('max_age', $ticket->max_age) }}" min="1">
                                            @error('max_age')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="active" name="active" 
                                                   {{ old('active', $ticket->active) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="enabled" name="enabled" 
                                                   {{ old('enabled', $ticket->enabled) ? 'checked' : '' }}>
