...
class HotelController extends Controller
{
    ...
    /**
     * Get List Hotel (Unified - Regular + Supplier)
     * @OA\Get (
     *     path="/api/hotels",
     *     tags={"Hotels"},
     *     summary="Get all hotels (regular + supplier)",
     *     description="Retrieve a paginated list of all hotels including both regular hotels and approved supplier hotels, sorted by commission rate (highest first)",
     *    @OA\Parameter(
