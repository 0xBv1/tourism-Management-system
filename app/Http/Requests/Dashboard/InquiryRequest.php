...
class InquiryRequest extends FormRequest
{
    ...
    public function attributes(): array
    {
        return [
            ...
            "assigned_reservation_id" => "Reservation User",
            "assigned_operator_id" => "Operator User",
            "assigned_admin_id" => "Admin User",
    ...
    public function rules(): array
    {
        return [
            ...
            'assigned_reservation_id' => ['nullable', 'exists:users,id'],
